...
const getEvePath = (): string => path.join(os.homedir(), 'AppData', 'Roaming', 'EVE Online');
const getStateFilePath = (profileName: string): string => path.join(getEvePath(), `state-${profileName}.json`);
